    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-gray-950/80 backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-3 md:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Guest banner — nudge to sign up */}
          {isSignedIn === false && (
            <span className="hidden text-xs text-gray-500 sm:block">
              Mode invité — vos tâches ne sont pas sauvegardées en ligne
            </span>
          )}
          ...
          <Show when="signed-out">
            ...
            <SignUpButton mode="modal">
              <button className="rounded-xl bg-gradient-to-r from-red-500 to-orange-500 px-4 py-2 text-sm font-semibold text-white transition-opacity hover:opacity-90">S&apos;inscrire</button>
            </SignUpButton>
          </Show>
