...
export default function TaskItem({ task, onStart, onComplete, onFail, onRemove }: TaskItemProps) {
  const isActive = task.status !== "completed" && task.status !== "failed";
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 mt-0.5">
          ...
          {isCurrentTask && <span className="text-xs text-amber-300">Pomodoro lié</span>}
